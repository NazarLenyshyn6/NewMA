...
class Memory(BaseSchema):
    ...
    an agent’s interaction with a user, including analysis, visualization,
    code summaries, variables, and conversation history. Designed for read
    ...
    Attributes:
        ...
        analysis_summary: Serialized binary summary of analysis results.
        visualization_summary: Serialized binary summary of visualization results.
        code_summary: Serialized binary summary of code insights.
        variables: Serialized snapshot of variables from the session.
        conversation: Serialized binary representation of conversation history.
    """

    user_id: int
    session_id: UUID
    file_name: str
    analysis_summary: Optional[bytes]

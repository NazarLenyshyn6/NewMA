...
"""
            ...
            "  • Only if absolutely unavoidable, allow **up to 2 subplots within the single figure**.\n"
            ...
            "- Before any visualization code in a generated block, initialize a **fresh** global `images = None` variable.\n"
            "- Store the **Base64-encoded string of the single figure** in `images` — never display directly and never use a list.\n"
            "- Output must contain exactly one Base64 string representing the single figure (with 1–2 subplots max).\n"
            "- No image may be output in any form other than the Base64 string stored in `images`.\n"

...
business_conversation_summarization_prompt = ChatPromptTemplate.from_messages(
    [
        SystemMessagePromptTemplate.from_template(
            ...
            "- If the memory is empty, initialize the summary with exactly three top-level sections: 'Technical', 'Business', and 'Common'.\n"
            "- Populate only the 'Business' section on initialization; leave 'Technical' and 'Common' empty.\n"
            ...
            "- Ensure that the same 'Immediate Action' is also updated in the 'Common' section.\n"
        ...
        HumanMessagePromptTemplate.from_template(
            ...
            "If the summary is empty, initialize with 'Technical', 'Business', and 'Common' sections, but populate only 'Business'.\n"
            "If 'Technical' already has content, leave it completely unchanged.\n"
            "Ensure 'Immediate Action' is updated in both 'Business' and 'Common' sections and reflects the latest user question's suggested next step.\n"

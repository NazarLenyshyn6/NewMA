...
expert_code_gen_prompt = ChatPromptTemplate.from_messages(
    [
...
"""
            ...
            "- **VISUALIZATION IS STRICTLY FORBIDDEN — NEVER generate, attempt, or include any visualization under any circumstance.**\n"
        ...
        HumanMessagePromptTemplate.from_template(
            ...
            "- **ABSOLUTELY NO VISUALIZATION IS ALLOWED under any circumstance.**\n"
            "- **GENERATE CODE AS SHORT AS POSSIBLE, WITHOUT ANY REDUNDANCY, FOCUSING ONLY ON THE PLAN, READY FOR STREAMING.**"
        ),
    ]
)

...
conversation_summarization_prompt = ChatPromptTemplate.from_messages(
    [
        SystemMessagePromptTemplate.from_template(
            ...
            "Additionally, you must maintain a separate clearly labeled 'Last Question Summary' section that provides a short, factual summary "
            "of the most recent user question and its context, updated incrementally to always reflect the latest question received.\n"
            ...
            "9. The 'Last Question Summary' section must always concisely summarize the latest user question in the context of the project.\n"
        ),
        HumanMessagePromptTemplate.from_template(
            ...
            "You must also update the 'Last Question Summary' section to concisely reflect the latest user question in context.\n"

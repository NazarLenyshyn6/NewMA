...
technical_conversation_summarization_prompt = ChatPromptTemplate.from_messages(
    [
        SystemMessagePromptTemplate.from_template(
            ...
            "- If the 'Business' section already contains content, **never alter it except for removing information that is now fully resolved in 'Technical'**. "
            "Do not add, modify, or remove any other part of the Business section.\n\n"
            "Within the 'Technical' section, always include:\n"
            "- A 'Technical Immediate Action' subsection reflecting the latest proposed next step based on the last user question and current context. "
            "If no action is required, explicitly state: 'No immediate action required.'\n"
            "- A 'Behavior State' subsection reflecting the current working mode: either 'Reasoning Mode' or 'Execution Mode'.\n"
            ...
            "- A 'Business Immediate Action' subsection reflecting the latest proposed next step from a business perspective.\n"
            "- Do not modify other content in Business except removing gaps now fully addressed by Technical.\n\n"
            "Within the summary, maintain a 'Common Immediate Action' subsection:\n"
            "- This should always reflect the latest actionable step, whether from Technical or Business updates.\n"
            "- Update this subsection whenever Technical or Business proposes an action.\n\n"
            ...
            "9. If Technical insights now fully address gaps previously noted in Business, remove only the resolved information from the Business section; "
            "do not modify or add any other content in Business.\n"
            "10. The entire summary must be easy to scan and ready for immediate reuse in guiding technical decisions.\n"
        ),
        HumanMessagePromptTemplate.from_template(
            ...
            "- Update 'Technical Immediate Action' and 'Common Immediate Action' based on technical context.\n"
            "- Update 'Business Immediate Action' and 'Common Immediate Action' based on business context.\n"
            "- If 'Business' already has content, leave it completely unchanged except for removing gaps now fully addressed by Technical.\n"

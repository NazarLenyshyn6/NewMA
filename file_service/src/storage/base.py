...
loading, and summarization. Specific storage backends (local filesystem,
...
class BaseStorage(ABC):
    ...
    def summarize_file(cls, file: UploadFile, extension: str) -> str:
        """
        Generate a summary of a file's content including shape and column types.
        ...
        Returns:
            str: Human-readable summary of the dataset.
        """
